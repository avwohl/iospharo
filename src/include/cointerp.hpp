...
extern void setDesiredCogCodeSize(sqInt dccs);
...
extern sqInt fixedPermSpaceStart(VMMemoryMap * self_in_fixedPermSpaceStart);
extern uint64_t getNewSpaceStart(VMMemoryMap * self_in_getNewSpaceStart);
extern uint64_t getOldSpaceStart(VMMemoryMap * self_in_getOldSpaceStart);
extern sqInt isInCodeZone(VMMemoryMap * self_in_isInCodeZone, sqInt anOop);
extern sqInt isOldObject(VMMemoryMap * self_in_isOldObject, sqInt anOop);
extern sqInt isPermanentObject(VMMemoryMap * self_in_isPermanentObject, sqInt anOop);
extern sqInt isYoungObject(VMMemoryMap * self_in_isYoungObject, sqInt anOop);
extern uint64_t startOfObjectMemory(VMMemoryMap * self_in_startOfObjectMemory);
extern sqInt rememberWithoutMarkingAsRemembered(VMRememberedSet * self_in_rememberWithoutMarkingAsRemembered, sqInt objOop);
extern sqInt remember(VMRememberedSet * self_in_remember, sqInt objOop);


/*** Global Variables ***/
VM_EXPORT extern sqInt breakLookupClassTag;
VM_EXPORT extern char * breakSelector;
VM_EXPORT extern sqInt breakSelectorLength ;
VM_EXPORT extern sqInt checkAllocFiller;
VM_EXPORT extern sqInt checkedPluginName;
VM_EXPORT extern sqInt checkForLeaks;
VM_EXPORT extern sqInt debugCallbackInvokes;
VM_EXPORT extern sqInt debugCallbackPath;
VM_EXPORT extern sqInt debugCallbackReturns;
VM_EXPORT extern sqInt desiredCogCodeSize;
VM_EXPORT extern sqInt desiredEdenBytes;
VM_EXPORT extern sqInt desiredNumStackPages;
VM_EXPORT extern void * displayBits;
VM_EXPORT extern int displayDepth;
VM_EXPORT extern int displayHeight;
VM_EXPORT extern int displayWidth;
VM_EXPORT extern sqInt extraVMMemory;
VM_EXPORT extern sqInt ffiExceptionResponse;
VM_EXPORT extern struct VirtualMachine* interpreterProxy;
VM_EXPORT extern sqInt maxLiteralCountForCompile ;
VM_EXPORT extern usqInt maxOldSpaceSize;
VM_EXPORT extern sqInt minBackwardJumpCountForCompile ;
VM_EXPORT extern volatile int sendTrace;
VM_EXPORT extern int (*showSurfaceFn)(sqIntptr_t, int, int, int, int);
VM_EXPORT extern sqInt suppressHeartbeatFlag;
