...
#define setInterpreter B2DPlugin_setInterpreter
#define getModuleName B2DPlugin_getModuleName
#define interpreterProxy B2DPlugin_interpreterProxy
#define initialiseModule B2DPlugin_initialiseModule
