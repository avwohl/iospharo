...
#define setInterpreter DSAPrims_setInterpreter
#define getModuleName DSAPrims_getModuleName
#define interpreterProxy DSAPrims_interpreterProxy
...
#else
	"DSAPrims CryptographyPlugins-eem.14 (e)"
#endif
;
