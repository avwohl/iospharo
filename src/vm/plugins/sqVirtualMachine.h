...
typedef struct VirtualMachine {
    ...
    /* VM_PROXY_MINOR > 1 - BitBlt support */
    ...
    /* VM_PROXY_MINOR > 9 */
    /* VM_PROXY_MINOR > 13 - returnBool/Float/Integer/String */
