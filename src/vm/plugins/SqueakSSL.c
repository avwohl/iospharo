/*
 * SqueakSSL.c — SSL/TLS plugin
 *
 * This file was generated by VMMaker and is part of OpenSmalltalk-VM / Pharo-VM.
...
/* Symbol renames to avoid linker collisions with other VMMaker plugins */
#define setInterpreter SqueakSSL_setInterpreter
#define getModuleName SqueakSSL_getModuleName
#define interpreterProxy SqueakSSL_interpreterProxy
