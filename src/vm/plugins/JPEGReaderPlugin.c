...
#define setInterpreter JPEGReaderPlugin_setInterpreter
#define getModuleName JPEGReaderPlugin_getModuleName
#define interpreterProxy JPEGReaderPlugin_interpreterProxy
