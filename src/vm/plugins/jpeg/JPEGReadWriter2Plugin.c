...
#define setInterpreter JPEGReadWriter2Plugin_setInterpreter
#define getModuleName JPEGReadWriter2Plugin_getModuleName
#define interpreterProxy JPEGReadWriter2Plugin_interpreterProxy
