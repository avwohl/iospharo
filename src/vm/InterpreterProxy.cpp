...
// VMMaker-generated plugin functions return `sqInt` (= long); our
// Interpreter::ExternalPrimFunc is declared `int (*)(void)` to match
// VM-internal primitives.  The plugin-side return value is discarded
// in callExternalPrimitive (Interpreter.cpp:16428), so casting across
// the int-vs-long return type is benign — but clang flags every
// registerNamedPrimitive call in this file with -Wcast-function-type-
// mismatch.  Disable the diagnostic file-wide; the casts are all
// intentional plugin-registration glue.
...
extern "C" {
    ...
    sqInt sp_primitiveSocketListenWithOrWithoutBacklog(void);
...
void initializeSocketPlugin(Interpreter* interp) {
    ...
    struct { const char* name; PrimFn fn; } prims[] = {
        ...
        {"primitiveSocketListenWithOrWithoutBacklog", sp_primitiveSocketListenWithOrWithoutBacklog},
