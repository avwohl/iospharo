# WIP archive — 2026-05-27 through 2026-08-23

Archived from `docs/WIP.md` on 2026-08-23, following the same convention
`docs/deferred.md` used on 2026-08-12: the working file is pruned to current
state, and the history moves here rather than being deleted.

Entries are newest-first, exactly as they were stacked in WIP.md. Everything in
this file is a **record of what was believed at the time**, including the
retractions and corrections — several entries are explicitly contradicted by a
later (higher) one, which is why they were pruned out of the working file.
Nothing here should be treated as current. For current state read `docs/WIP.md`;
for the routing table to the durable docs read the header of
`docs/deferred.md`.

The full text also remains in git history (`git log -p docs/WIP.md`).
